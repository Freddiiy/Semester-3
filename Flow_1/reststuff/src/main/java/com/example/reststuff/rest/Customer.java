package com.example.reststuff.rest;
...
public class Customer {
    ...
    @Path("/employee/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    public Response getCustomerByEmployeeId(@PathParam("id")long id) {
        List<CustomerDTO> customerDTOList = facade.getCustomersByEmployeeId(id);
        return Response
                .ok()
